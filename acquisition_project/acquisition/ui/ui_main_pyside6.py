...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font2.setBold(True)
        self.label_sentence.setFont(font2)
        ...
        sizePolicy2.setHeightForWidth(self.button_record.sizePolicy().hasHeightForWidth())
        self.button_record.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.select_language.sizePolicy().hasHeightForWidth())
        self.select_language.setSizePolicy(sizePolicy2)
        ...
        self.area_device = QWidget(self.area_menu)
        ...
        sizePolicy2.setHeightForWidth(self.select_micro.sizePolicy().hasHeightForWidth())
        self.select_micro.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.button_test_micro.sizePolicy().hasHeightForWidth())
        self.button_test_micro.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.progressbar_micro_level.sizePolicy().hasHeightForWidth())
        self.progressbar_micro_level.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.select_camera.sizePolicy().hasHeightForWidth())
        self.select_camera.setSizePolicy(sizePolicy2)
        ...
        self.horizontalLayout_2.addWidget(self.area_menu)
        ...
        sizePolicy3.setHeightForWidth(self.area_video.sizePolicy().hasHeightForWidth())
        self.area_video.setSizePolicy(sizePolicy3)
        ...
        sizePolicy2.setHeightForWidth(self.area_record.sizePolicy().hasHeightForWidth())
        self.area_record.setSizePolicy(sizePolicy2)
