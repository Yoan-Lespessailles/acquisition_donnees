...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.area_video.sizePolicy().hasHeightForWidth())
        self.area_video.setSizePolicy(sizePolicy)
...
"border-radius: 10px;")
        ...
        sizePolicy2.setHeightForWidth(self.area_preview.sizePolicy().hasHeightForWidth())
        self.area_preview.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.area_menu.sizePolicy().hasHeightForWidth())
        self.area_menu.setSizePolicy(sizePolicy3)
        ...
        self.area_sentence.setFont(font1)
        ...
        sizePolicy2.setHeightForWidth(self.label_sentence.sizePolicy().hasHeightForWidth())
        self.label_sentence.setSizePolicy(sizePolicy2)
        font3 = QFont()
